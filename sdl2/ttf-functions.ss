...
(define-sdl-func (* sdl-surface-t) ttf-render-text-solid ((font (* ttf-font)) (text string) (fg (& sdl-color-t))) "TTF_RenderText_Solid")
(define-sdl-func (* sdl-surface-t) ttf-render-ut-f8-solid ((font (* ttf-font)) (text string) (fg (& sdl-color-t))) "TTF_RenderUTF8_Solid")
(define-sdl-func (* sdl-surface-t) ttf-render-unicode-solid ((font (* ttf-font)) (text (* uint16)) (fg (& sdl-color-t))) "TTF_RenderUNICODE_Solid")
(define-sdl-func (* sdl-surface-t) ttf-render-glyph-solid ((font (* ttf-font)) (ch uint16) (fg (& sdl-color-t))) "TTF_RenderGlyph_Solid")
(define-sdl-func (* sdl-surface-t) ttf-render-text-shaded ((font (* ttf-font)) (text string) (fg (& sdl-color-t)) (bg (& sdl-color-t))) "TTF_RenderText_Shaded")
(define-sdl-func (* sdl-surface-t) ttf-render-ut-f8-shaded ((font (* ttf-font)) (text string) (fg (& sdl-color-t)) (bg (& sdl-color-t))) "TTF_RenderUTF8_Shaded")
(define-sdl-func (* sdl-surface-t) ttf-render-unicode-shaded ((font (* ttf-font)) (text (* uint16)) (fg (& sdl-color-t)) (bg (& sdl-color-t))) "TTF_RenderUNICODE_Shaded")
(define-sdl-func (* sdl-surface-t) ttf-render-glyph-shaded ((font (* ttf-font)) (ch uint16) (fg (& sdl-color-t)) (bg (& sdl-color-t))) "TTF_RenderGlyph_Shaded")
(define-sdl-func (* sdl-surface-t) ttf-render-text-blended ((font (* ttf-font)) (text string) (fg (& sdl-color-t))) "TTF_RenderText_Blended")
(define-sdl-func (* sdl-surface-t) ttf-render-ut-f8-blended ((font (* ttf-font)) (text string) (fg (& sdl-color-t))) "TTF_RenderUTF8_Blended")
(define-sdl-func (* sdl-surface-t) ttf-render-unicode-blended ((font (* ttf-font)) (text (* uint16)) (fg (& sdl-color-t))) "TTF_RenderUNICODE_Blended")
(define-sdl-func (* sdl-surface-t) ttf-render-text-blended-wrapped ((font (* ttf-font)) (text string) (fg (& sdl-color-t)) (wrapLength uint32)) "TTF_RenderText_Blended_Wrapped")
(define-sdl-func (* sdl-surface-t) ttf-render-ut-f8-blended-wrapped ((font (* ttf-font)) (text string) (fg (& sdl-color-t)) (wrapLength uint32)) "TTF_RenderUTF8_Blended_Wrapped")
(define-sdl-func (* sdl-surface-t) ttf-render-unicode-blended-wrapped ((font (* ttf-font)) (text (* uint16)) (fg (& sdl-color-t)) (wrapLength uint32)) "TTF_RenderUNICODE_Blended_Wrapped")
(define-sdl-func (* sdl-surface-t) ttf-render-glyph-blended ((font (* ttf-font)) (ch uint16) (fg (& sdl-color-t))) "TTF_RenderGlyph_Blended")
