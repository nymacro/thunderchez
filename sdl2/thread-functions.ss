...
(define-sdl-func (* sdl-thread-t) sdl-create-thread-with-stack-size ((fn (& sdl-thread-function-t)) (name string) (stacksize size-t) (data void*)) "SDL_CreateThreadWithStackSize")
