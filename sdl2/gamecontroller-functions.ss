...
(define-sdl-func string sdl-game-controller-mapping-for-device-index ((joystick_index int)) "SDL_GameControllerMappingForDeviceIndex")
...
(define-sdl-func int sdl-game-controller-get-player-index ((gamecontroller (* sdl-game-controller-t))) "SDL_GameControllerGetPlayerIndex")
...
(define-sdl-func int sdl-game-controller-rumble ((gamecontroller (* sdl-game-controller-t)) (low_frequency_rumble uint16) (high_frequency_rumble uint16) (duration_ms uint32)) "SDL_GameControllerRumble")
